...
void Motor_Function(void)
{
    ...
    motor_mode       = rx_buffer[1];
    data_value1 = rx_buffer[2];
    data_value0   = data_value1 * 100;
    data_value2 = rx_buffer[3];
    stepping_angle= data_value0 + data_value2;
}
